    ...
    const fetchQuestions = async () => {
        ...
        if (auth.currentUser) {
          ...
          if (!querySnapshot.empty) {
            ...
            navigate('/dashboard', { state: { message: 'You have already taken today’s quiz.' } });
          }
        }
        setLoading(false);
    };
  ...
  return (
    <div style={styles.container}>
      ...
      <div style={styles.cont}>
        <p style={styles.questionText}>Question {currentQuestionIndex + 1}: {currentQuestion.question}</p>
      </div>  
